...
public class TSP {
    ...
    public static void main(String[] args) {
        //String[] names = {"017", "021", "026", "042", "048", "058", "175", "180", "535"};
        String[] names = {"535"};
        //,"175","180", "535"
    ...
    private static void run() {
        try {
            ...
            if (tourCost < currentBest) {
                ...
                writeTextFile(tour.length, tourCost, MatrixWrapper.toString(tour));
            }
        } catch (Exception ex) {
    ...
    private static void processText(String input) throws Exception {
        ...
        for (int i = 2; i < values.length; i++) {
            ...
            for (int j = 0; j < dist.length; j++) {
                ...
                //distances[j + 1 + (i - 2)][i - 2] = distances[i - 2][j + 1 + (i - 2)];
            }
        }
    }

    private static void writeTextFile(int num, int cost, String pathString) throws IOException {
        try {
            ...
            BufferedWriter out = new BufferedWriter(new FileWriter(tourFileName));
            out.write(output);
            out.close();
